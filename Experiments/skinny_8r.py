            ...
            if out0 == out1:
                ...
                for x0 in range(1, 16):
                    ...
                    if out0 != out1:
                        success = 0
                if success == 1:
                    print("pass, s={:x}, a00={:x}, a01={:x}, a30={:x}, a31={:x}, a40={:x}, a41={:x}, a50={:x}, a51={:x}, a60={:x}, a61={:x}, a70={:x}, a71={:x}, a100={:x}, a101={:x}, a110={:x}, a111={:x}, a130={:x}, a131={:x}, a140={:x}, a141={:x}".format(s, a00, a01, a30, a31, a40, a41, a50, a51, a60, a61, a70, a71, a100, a101, a110, a111, a130, a131, a140, a141))
                    # print("i={:x}".format(i))
                    counter += 1
