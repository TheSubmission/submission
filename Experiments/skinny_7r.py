        ...
        for s in range(1, 16):
            ...
            if out0 == out1:
                ...
                if success == 1:
                    ...
                    print("input0 state is: {:x},{:x},{:x},{:x},{:x},{:x},x,{:x},{:x},{:x},{:x},{:x},{:x},{:x},{:x}".format(c0, c1, c2, c3, c4, c5, c7, c8, a40, c10, c11, a40, c13, c14, c15))
                    print("input1 state is: {:x},{:x},{:x},{:x},{:x},{:x},x,{:x},{:x},{:x},{:x},{:x},{:x},{:x},{:x}".format(c0, c1, c2, c3, c4, c5, c7, c8, a41, c10, c11, a41, c13, c14, c15))
                    counter += 1
                    break
