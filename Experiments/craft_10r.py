        ...
        for s in range(1, 16):
            ...
            if out0 == out1:
                ...
                if success == 1:
                    ...
                    print("input0 state is: {:x},{:x},{:x},{:x},x,{:x},{:x},{:x},{:x},{:x},{:x},{:x},{:x},{:x},{:x}".format(a40, b40, c2, e40, c5, c6, c7,c8, b40, c10, c11, a40, c13, d40, e40))
                    print("input1 state is: {:x},{:x},{:x},{:x},x,{:x},{:x},{:x},{:x},{:x},{:x},{:x},{:x},{:x},{:x}".format(a41, b41, c2, e41, c5, c6, c7,c8, b41, c10, c11, a41, c13, d41, e41))
