...
#K2 = [random.randint(0, 255) for _ in range(20)]
#C0 = [random.randint(0, 255) for _ in range(20)]
#C1 = [random.randint(0, 255) for _ in range(20)]
#C2 = [random.randint(0, 255) for _ in range(20)]

def F0(input, round, K0, K1, K2, C0, C1, C2):
    output = S[input^K0[round]]^C0[round]
    return output

def F1(input, round, K0, K1, K2, C0, C1, C2):
    output = S[input^K1[round]]^C1[round]
    return output

def F2(input, round, K0, K1, K2, C0, C1, C2):
    output = S[input^K2[round]]^C2[round]
    return output

def ROUND(in0,in1,in2,in3,round, K0, K1, K2, C0, C1, C2):
    out0 = in1 ^ F0(in0, round, K0, K1, K2, C0, C1, C2)
    out1 = in2 ^ F1(in1, round, K0, K1, K2, C0, C1, C2)
    out2 = in3 ^ F2(in2, round, K0, K1, K2, C0, C1, C2)
    out3 = in0
...
if __name__ == '__main__':
    ...
    C2 = [random.randint(1, 15) for i in range(20)]
    ...
    for ax,ay in tqdm(Arange):
        ...
        for order in range(1):
            for xy in range(256):
                ...
                x0, x1, x2, x3 = ax,c0,c1,xy
                y0, y1, y2, y3 = ay,c0,c1,xy
                for r in range(R):
                    x0,x1,x2,x3 = ROUND(x0,x1,x2,x3,r, K0, K1, K2, C0, C1, C2)
                    y0,y1,y2,y3 = ROUND(y0,y1,y2,y3,r, K0, K1, K2, C0, C1, C2)
                    #print(x0, x1, x2, x3)
                    #print(y0, y1, y2, y3)
            ...
            for s in range(1,256):
                ...
                for i in range(4):
                    if counter[i] == 256:
                        ...
                        print('input0: ', ax, c0, c1, 'x')
                        print('input1: ', ay, c0, c1, 'x')
